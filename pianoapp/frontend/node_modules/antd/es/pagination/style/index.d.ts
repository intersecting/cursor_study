import type { SharedComponentToken, SharedInputToken } from 'antd/es/input/style/token';
import type { FullToken, GenStyleFn, GetDefaultToken } from 'antd/es/theme/internal';
